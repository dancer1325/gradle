...
* `gradle tasks`
    ** list 👀 ONLY the main tasks 👀 & description about it | selected project
        *** main == tasks / -- assigned to a -- task group
    ** `--all`
        *** obtain MORE information
    ** `--no-all`
        *** report tasks / -- assigned to a -- task group
    ** `--group groupTaskNameToFilter`
        *** ONLY display the tasks / -- from a -- specific group
...
* task group
    ** types
        ...
        *** build
        *** ...
    ** if you list the tasks -> header of each section

----
> Task :tasks

Build tasks             # Task group
-----------
...
Distribution tasks      # Task group
------------------
assembleDist - Assembles the main distributions

Documentation tasks     # Task group
-------------------
