...
* build lifecycle
    ** <<writing_settings_files.adoc#writing_settings_files,Initialization Phase>>
    ** TODO:
* build script file
    ** / EACH project | settings file Gradle creates a link:{javadocPath}org/gradle/api/Project.html[`Project`] instance.
